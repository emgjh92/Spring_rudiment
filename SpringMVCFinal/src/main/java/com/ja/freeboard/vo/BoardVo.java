...
public class BoardVo {
	...
	public BoardVo(int board_no, int memebr_no, String board_title, String board_content, String board_readcount,
			Date board_writedate) {
		super();
		this.board_no = board_no;
		this.member_no = memebr_no;
	...
	public void setMember_no(int memebr_no) {
		this.member_no = memebr_no;
	}
