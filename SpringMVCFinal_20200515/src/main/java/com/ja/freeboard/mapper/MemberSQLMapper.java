...
public interface MemberSQLMapper {
	...
	@Select("select * from fb_member m, fb_member_auth a where m.member_id=#{member_id} and m.member_pw=#{member_pw} and m.member_no = a.member_no and a.auth_certification = 'Y'")
